...
<html lang="en">
  <head>
    ...
    <title>Add Question - MarkoVoice</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-question-circle"></i><span class="app-menu__label">Question Management</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item active" href="./add-question"><i class="icon fa fa-circle-o"></i> Add Question</a></li>
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Add Question</h3>
            <div class="tile-body">
              <form class="form-horizontal">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <textarea class="form-control" rows="4" placeholder="Enter training phrases separated by comma"></textarea>
                  </div>
                </div>
                <div class="form-group row">
            ...
            <div class="tile-footer">
              <div class="row">
                <div class="col-md-8 col-md-offset-3">
                  <button class="btn btn-primary" type="button"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add Question</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="#"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                </div>
              </div>
            </div>
          </div>
