...
<html lang="en">
  <head>
    ...
    <meta property="og:site_name" content="MarkoVoice">
    <meta property="og:title" content="MarkoVoice - Free Bootstrap 4 admin theme">
    <meta property="og:url" content="http://pratikborsadiya.in/blog/vali-admin">
    <meta property="og:image" content="http://pratikborsadiya.in/blog/vali-admin/hero-social.png">
    <meta property="og:description" content="Vali is a responsive and free admin theme built with Bootstrap 4, SASS and PUG.js. It's fully customizable and modular.">
    <title>Edit Question - MarkoVoice</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="./visitor-list"><i class="app-menu__icon fa fa-user-circle-o"></i><span class="app-menu__label">Visitor List</span></a></li>
            ...
            <div class="tile-body">
              <form class="form-horizontal">
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" value="AgentNameIntent" placeholder="Enter question title">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Training Phrases</label>
                  <div class="col-md-8">
                    <textarea class="form-control" rows="4" placeholder="Enter training phrases separated by comma">what is your name,can you tell me your name</textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Response Audio</label>
                  <div class="col-md-8">
                    <input type="file">
                  </div>
                </div>
            ...
            <div class="tile-footer">
              <div class="row">
                <div class="col-md-8 col-md-offset-3">
                  <button class="btn btn-primary" type="button"><i class="fa fa-fw fa-lg fa-check-circle"></i>Edit Question</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="#"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                </div>
              </div>
            </div>
          </div>
