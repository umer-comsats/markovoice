...
<html lang="en">
  <head>
    ...
    <title>Question List - MarkoVoice</title>
    <meta charset="utf-8">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-question-circle"></i><span class="app-menu__label">Question Management</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="./question-list" rel="noopener"><i class="icon fa fa-circle-o"></i> Question List</a></li>
          </ul>
        </li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>check all the questions added</p>
        </div>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <tr>
                        ...
                        <td>2020/08/01</td>
                        <td>
                            <a href="./edit-question" class="btn btn-outline-primary" type="button">Edit</a>&nbsp;&nbsp;
