...
<html lang="en">
  <head>
    ...
    <title>Interaction List - MarkoVoice</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="./interaction-list"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Interaction List</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Interaction List</h1>
          <p>check all the interaction</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Interaction List</li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
